...
function NeptuneIcon({ size }: { size: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <rect x="10" y="10" width="3" height="34" rx="1.5" fill="#2563eb" />
      <rect x="51" y="10" width="3" height="34" rx="1.5" fill="#2563eb" />

      {/* Top frame bar */}
      <rect x="8" y="8" width="48" height="3" rx="1.5" fill="#2563eb" />

      {/* X-axis gantry (horizontal bar that holds extruder) */}
      <rect x="10" y="22" width="44" height="2.5" rx="1.25" fill="#3b82f6" />

      {/* Extruder carriage */}
      <rect x="27" y="18" width="10" height="10" rx="2" fill="#f59e0b" />
      <rect x="30" y="26" width="4" height="5" rx="1" fill="#fbbf24" />

      {/* Print bed */}
      <rect x="16" y="40" width="32" height="4" rx="1" fill="#10b981" opacity="0.85" />
